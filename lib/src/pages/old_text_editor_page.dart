...
//   const OldTextEditor({this.note, this.isNewNote = false, super.key});
...
//         userId: user.id, id: _noteModel.id, value: _noteModel.title!);

//     _firebaseManager.updateNoteText(
//         userId: user.id, id: _noteModel.id, value: _noteModel.text!);

//     _firebaseManager.updateLastModificationTime(docId: _noteModel.id);
//   }
