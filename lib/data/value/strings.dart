...
class LanguageBloc extends Cubit<Language> {
  LanguageBloc(LangState langState,[String? defaultLanguage]) : super(new Language(langState));

  static Language langFrench = new Language(LangState.fr);
  static Language langEnglish = new Language(LangState.en);
